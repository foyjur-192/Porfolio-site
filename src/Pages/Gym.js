...
import furniture from '../Pages/image/Gym1.png'
import furniture2 from '../Pages/image/gym2.png'
import furniture3 from '../Pages/image/gym3.png'
...
<div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
 ...
 <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 flex ml-80  ">
     ...
     <h1 class="title-font sm:text-2xl text-xl font-medium text-white mb-3">The gym Trainer website</h1>
        ...
        <button class="inline-flex text-white bg-css border-0 py-2 px-6 focus:outline-none hover:bg-cyan-400 rounded text-lg">  <a  href='https://personal-gym-trainer-c75ff.web.app/' target="_blank" rel='noopener noreferrer'>Live</a> </button>
        <button class="inline-flex text-white bg-css border-0 py-2 px-6 focus:outline-none hover:bg-cyan-400 rounded text-lg">  <a  href='https://github.com/foyjur-192/Personal-Gym-trainer' target="_blank" rel='noopener noreferrer'>Client Site</a> </button>
